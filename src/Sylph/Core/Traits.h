...
template<class T>
typename Traits::MakeSigned<T>::type makeSigned(T t) {
    return static_cast<typename Traits::MakeSigned<T>::type>(t);
}

template<class T>
typename Traits::MakeUnsigned<T>::type makeUnsigned(T t) {
    return static_cast<typename Traits::MakeUnsigned<T>::type>(t);
}

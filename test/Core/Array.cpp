...
namespace {
    ...
    TEST_F(TestArray, testInvertedRange) {
        ASSERT_THROW(arfilled1[range(3,2)], ArrayException);
    }

    TEST_F(TestArray, testInvertedNegativeRange) {
        ASSERT_THROW(arfilled1[range(-2,-3)], ArrayException);
    }

    TEST_F(TestArray, testInvertedDifferentlySignedRange) {
        ASSERT_THROW(arfilled1[range(-1,1)], ArrayException);
    }

    TEST_F(TestArray, testInvalidRange) {
        ASSERT_THROW(arfilled1[range(3,6)], ArrayException);
    }

    TEST_F(TestArray, testInvalidNegativeRange) {
        ASSERT_THROW(arfilled1[range(-2,-7)], ArrayException);
    }

...
${OBJECTDIR}/src/Sylph/Core/DictionaryIterator.o: src/Sylph/Core/DictionaryIterator.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Sylph/Core
	${RM} $@.d
	$(COMPILE.cc) -g -DSYLPH_DEBUG -D__GXX_EXPERIMENTAL_CXX0X__ -Isrc -Ideps/binreloc -Ideps/boost -Ideps/gc/include -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Sylph/Core/DictionaryIterator.o src/Sylph/Core/DictionaryIterator.cpp

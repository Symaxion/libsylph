...
${OBJECTDIR}/src/Sylph/Core/StringBuffer.o: nbproject/Makefile-${CND_CONF}.mk src/Sylph/Core/StringBuffer.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -DSYLPH_DEBUG -D__GXX_EXPERIMENTAL_CXX0X__ -Isrc -Ideps/binreloc -Ideps/boost -Ideps/gc/include -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Sylph/Core/StringBuffer.o src/Sylph/Core/StringBuffer.cpp
...
${OBJECTDIR}/src/Sylph/Core/ByteBuffer.o: nbproject/Makefile-${CND_CONF}.mk src/Sylph/Core/ByteBuffer.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Sylph/Core
	${RM} $@.d
	$(COMPILE.cc) -g -DSYLPH_DEBUG -D__GXX_EXPERIMENTAL_CXX0X__ -Isrc -Ideps/binreloc -Ideps/boost -Ideps/gc/include -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Sylph/Core/ByteBuffer.o src/Sylph/Core/ByteBuffer.cpp

${OBJECTDIR}/src/Sylph/IO/BufferedInputStream.o: nbproject/Makefile-${CND_CONF}.mk src/Sylph/IO/BufferedInputStream.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Sylph/IO
	${RM} $@.d
	$(COMPILE.cc) -g -DSYLPH_DEBUG -D__GXX_EXPERIMENTAL_CXX0X__ -Isrc -Ideps/binreloc -Ideps/boost -Ideps/gc/include -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Sylph/IO/BufferedInputStream.o src/Sylph/IO/BufferedInputStream.cpp
...
${OBJECTDIR}/src/Sylph/OS/MacOSFHSAppSelf.o: nbproject/Makefile-${CND_CONF}.mk src/Sylph/OS/MacOSFHSAppSelf.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Sylph/OS
	${RM} $@.d
	$(COMPILE.cc) -g -DSYLPH_DEBUG -D__GXX_EXPERIMENTAL_CXX0X__ -Isrc -Ideps/binreloc -Ideps/boost -Ideps/gc/include -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Sylph/OS/MacOSFHSAppSelf.o src/Sylph/OS/MacOSFHSAppSelf.cpp
...
${OBJECTDIR}/src/Sylph/IO/BufferedOutputStream.o: nbproject/Makefile-${CND_CONF}.mk src/Sylph/IO/BufferedOutputStream.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Sylph/IO
	${RM} $@.d
	$(COMPILE.cc) -g -DSYLPH_DEBUG -D__GXX_EXPERIMENTAL_CXX0X__ -Isrc -Ideps/binreloc -Ideps/boost -Ideps/gc/include -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Sylph/IO/BufferedOutputStream.o src/Sylph/IO/BufferedOutputStream.cpp
...
${OBJECTDIR}/src/Sylph/OS/MacOSAppSelf.o: nbproject/Makefile-${CND_CONF}.mk src/Sylph/OS/MacOSAppSelf.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Sylph/OS
	${RM} $@.d
	$(COMPILE.cc) -g -DSYLPH_DEBUG -D__GXX_EXPERIMENTAL_CXX0X__ -Isrc -Ideps/binreloc -Ideps/boost -Ideps/gc/include -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Sylph/OS/MacOSAppSelf.o src/Sylph/OS/MacOSAppSelf.cpp
